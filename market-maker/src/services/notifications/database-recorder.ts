...
export class DatabaseRecorder implements Notifier {
    ...
    private async recordLiquidation(payload: NotificationPayload): Promise<void> {
        ...
        insertLiquidation({
            ...
            debtAssetSymbol: meta.debtAssetSymbol ? String(meta.debtAssetSymbol) : undefined,
            collateralAssetSymbol: meta.collateralAssetSymbol ? String(meta.collateralAssetSymbol) : undefined,
            borrowedAmount: meta.borrowedAmount ? String(meta.borrowedAmount) : undefined,
            collateralAmount: meta.collateralAmount ? String(meta.collateralAmount) : undefined,
